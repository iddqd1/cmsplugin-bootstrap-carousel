...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CarouselItem.link'
        db.alter_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'link', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'CarouselItem.link'
        db.alter_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
