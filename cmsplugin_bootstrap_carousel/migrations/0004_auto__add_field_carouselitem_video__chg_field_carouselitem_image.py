...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CarouselItem.video'
        db.add_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'video',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'CarouselItem.image'
        db.alter_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting field 'CarouselItem.video'
        db.delete_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'video')


        # Changing field 'CarouselItem.image'
        db.alter_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
