...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CarouselItem.link'
        db.add_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CarouselItem.link'
        db.delete_column(u'cmsplugin_bootstrap_carousel_carouselitem', 'link')
